...
__decorate([
    (0, swagger_1.ApiCreatedResponse)({
        description: 'Checks if there is a User with the provided email, if not creates one and creates a token for them as well',
        type: auth_login_entity_1.AuthenticationResponse,
    }),
...
__decorate([
    (0, swagger_1.ApiOkResponse)({ description: 'Login', type: auth_login_entity_1.AuthenticationResponse }),
